...
$theme-colors: ( primary: $teal, secondary: $gray-600, success: $green, info: $cyan, warning: $yellow, danger: $red, light: $gray-100, dark: $gray-800) !default;
...
0 0 0 3px theme-color("primary") !default;
...
$custom-select-focus-border-color: lighten(theme-color("primary"),
25%) !default;
...
.75) !default;
$navbar-dark-active-color: rgba($white,
1) !default;
